...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    @Override
    public CategoryDto update(String prevName, String nextName) {
    ...
    @Override
    public CategoryDto updateDescription(CategoryDto categoryDto) {
        CategoryEntity categoryEntity = jpaRepository.findById(categoryDto.getId())
                .orElseThrow(() -> new ApiException(ErrorCode.BAD_REQUEST, "해당 이름은 카테고리 목록에 없습니다."));

        categoryEntity.updateDescription(categoryDto.getDescription());
